...
public class Board {
    ...
    /**
     * 
     * @param board char representation of the board to be printed
     */
    ...
    /**
     * Method to print the char representation of the board
     */
    ...
    /**
     * 
     * @return The char representation of the board
     */
    ...
    /**
     * 
     * @return Returns a char representation of the board, without the empty states,
    ...
    /**
     *
     * @param carsInTheWay - list of cars blocking the way of the player car, not
     *                     null
    ...
    private int getCarsBlockedRecursiveHeuristic(Stream<Car> carsInTheWay) {
        // phaseThroughMoves - number of moves to clear the way, if blocking cars were
        // free to move
